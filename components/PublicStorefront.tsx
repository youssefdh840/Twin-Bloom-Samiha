                ...
                outfits.map((outfit) => (
                  <div key={outfit.id} className="flex flex-col h-full group bg-white shadow-sm hover:shadow-xl transition-all duration-500 rounded-sm overflow-hidden">
                    ...
                    <div className="p-4 flex flex-col flex-grow bg-white">
                      <div className="mb-4">
                        <h3 className="text-[10px] md:text-xs font-semibold text-black uppercase tracking-[0.15em] line-clamp-2 min-h-[2.5em] leading-relaxed">
                          {outfit.name}
                        </h3>
                        <p className="text-[9px] md:text-[10px] text-gray-400 mt-2 italic tracking-wide">
                          Essence: <span className="matte-gold">{getScentName(outfit.pairedScentId)}</span>
                        </p>
                      </div>
