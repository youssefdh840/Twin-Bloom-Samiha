        ...
        <section className="px-6 mb-16">
          ...
          {!hasClient ? (
            <div className="py-20 text-center border border-dashed border-gray-200">
              <p className="text-[10px] text-gray-400 uppercase tracking-[0.2em] px-4 leading-relaxed">
                Backend connection pending configuration or initialization.
              </p>
            </div>
          ) : loading ? (
            ...
            <div className="space-y-8 animate-fade-in">
              {outfits.length === 0 ? (
                <div className="py-20 text-center">
                  <p className="text-sm text-gray-400 font-light italic">The collection is currently being reimagined.</p>
                </div>
              ) : (
                outfits.map((outfit) => (
