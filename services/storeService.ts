...
const mapFromDb = (row: any): OutfitType => ({
  ...
  showSizes: row.show_sizes !== undefined ? row.show_sizes : true,
});
...
export const storeService = {
  ...
  updateOutfit: async (id: string, updates: Partial<OutfitType>): Promise<OutfitType | null> => {
    ...
    try {
      ...
      if (updates.showSizes !== undefined) dbUpdates.show_sizes = updates.showSizes;
